...
seaborn_colors.load_palette("Blues_d", palette_dir=os.path.expandvars("$CMSSW_BASE/MyTools/RootUtils/python/seaborn_palettes"))
seaborn_colors.load_palette("Reds_d", palette_dir=os.path.expandvars("$CMSSW_BASE/MyTools/RootUtils/python/seaborn_palettes"))
seaborn_colors.load_palette("Oranges_d", palette_dir=os.path.expandvars("$CMSSW_BASE/MyTools/RootUtils/python/seaborn_palettes"))
seaborn_colors.load_palette("Greens_d", palette_dir=os.path.expandvars("$CMSSW_BASE/MyTools/RootUtils/python/seaborn_palettes"))
seaborn_colors.load_palette("Purples_d", palette_dir=os.path.expandvars("$CMSSW_BASE/MyTools/RootUtils/python/seaborn_palettes"))
