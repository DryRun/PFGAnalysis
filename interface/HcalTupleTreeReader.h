...
// from TTree HcalTupleTreeReader/
// found on file: hcalTupleTree.root
//////////////////////////////////////////////////////////

#ifndef HcalTupleTreeReader_h
#define HcalTupleTreeReader_h
...
class HcalTupleTreeReader : public TSelector {
public :
   ...
   HcalTupleTreeReader(TTree * /*tree*/ =0) { }
   virtual ~HcalTupleTreeReader() { }
   ...
   ClassDef(HcalTupleTreeReader,0);

};

#endif

#ifdef HcalTupleTreeReader_cxx
void HcalTupleTreeReader::Init(TTree *tree)
{
   // The Init() function is called when the selector needs to initialize
   // a new HcalTupleTreeReader or chain. Typically here the reader is initialized.
...
Bool_t HcalTupleTreeReader::Notify()
{
...
#endif // #ifdef HcalTupleTreeReader_cxx
